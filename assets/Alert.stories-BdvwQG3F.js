const A=({text:i,variant:o="default"})=>{const e=document.createElement("div");return e.className="alert",e.role="alert",e.innerHTML=i,o!=="default"&&e.classList.add(o),e},E={title:"Components/Alert",render:({...i})=>A({...i}),argTypes:{text:{control:"text"}}},r={args:{text:"this is a base alert text"}},a={args:{text:"this is a base alert text",variant:"danger"}},t={args:{text:"This is a text indicating success!",variant:"success"}},s={args:{text:"This is a text indicating error!",variant:"error"}},n={args:{text:"This is a text indicating warning!",variant:"warning"}};var c,d,g;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
