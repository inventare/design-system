import{c as rr,a as ar}from"./SidebarButton-CDkh1oGj.js";const er={title:"Components/SidebarButton",render:({...g})=>g.complete?rr():ar({...g}),argTypes:{label:{control:"text"},variant:{control:{type:"select"},options:["primary","danger"]},disabled:{control:"boolean"},dropDown:{control:"boolean"},expanded:{control:"boolean"},childPosition:{control:{type:"select"},options:["start","middle","end"]}}},r=`
