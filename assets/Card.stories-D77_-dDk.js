...
`,x=({title:o,text:y,footerRight:v,iconed:n})=>{const a=document.createElement("div");a.className=`card ${n?"iconed":""}`;let s=`
  ...
  `;return n&&(s=`<div class="card-inner">${s}</div><div class="card-icon-container">${C}</div>`),a.innerHTML=s,a},A={title:"Layout/Card",render:({...o})=>x({...o}),argTypes:{title:{control:"title"},text:{control:"text"},footerRight:{control:"boolean"},iconed:{control:"boolean"}}},e={args:{title:"CRM",text:"Manage your customers all in one place."}},t={args:{title:"Customer Support",text:"Add people to your team and control what they can access.",footerRight:!0}},r={args:{title:"Customer Support",text:"Add people to your team and control what they can access.",iconed:!0}};var c,d,i;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    title: 'CRM',
