import{M as u}from"./ModalManager-BVnrIXzb.js";const p={title:"Vanilla JavaScript/Modal",render:({id:a="my-admin",center:i=!1,title:r="My modal title",subtitle:c="My modal subtitle"})=>{const e=document.createElement("div");e.innerHTML=`
